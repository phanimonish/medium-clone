        ...
        <div className="row">
          <div className="left-content col-8">
            <div className="li-items mt-4 ms-4 d-flex">
              ...
              <div>
                <p className="pb-0 mb-0 ps-4">For you</p>
              </div>

              <p className="pb-0 mb-0 ps-4">Following</p>
              <p className="pb-0 mb-0 ps-4">JavaScript</p>
              <p className="pb-0 mb-0 ps-4">React</p>
              <p className="pb-0 mb-0 ps-4">Web Development</p>
            </div>
            <hr className="" />
